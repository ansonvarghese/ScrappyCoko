...
public class TakePhotoActivity extends AppCompatActivity implements RevealBackgroundView.OnStateChangeListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton btnAccept = (ImageButton) findViewById(R.id.btnAccept);
      ...
      //  setupPhotoFilters();
        ...
        btnAccept.setOnClickListener(v -> Toast.makeText(getBaseContext(), ""+ Uri.fromFile(photoPath), Toast.LENGTH_SHORT).show());
        btnBack.setOnClickListener(v -> onBackPressed());
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    private void updateStatusBarColor() {
        if (DeviceUtils.isAndroid5()) {
