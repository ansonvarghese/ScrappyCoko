...
public class FeedAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements LinkPreview.PreviewListener{
   // private RecyclerView.RecycledViewPool mSharedPool = new RecyclerView.RecycledViewPool();
    private static final int VIEW_TYPE_DEFAULT = 1;
    private static final int VIEW_TYPE_LOADER = 2;

    private static final int VIEW_TYPE_NEWS_POST = 10;
    private static final int VIEW_TYPE_EVENT_POST = 11;
    private static final int VIEW_TYPE_NEW_USER_JOINED = 12;
    private static final int VIEW_TYPE_USER_PROFILE_POST = 13;
    private static final int VIEW_TYPE_FRIEND_PROFILE_POST = 14;
    private static final int VIEW_TYPE_FRIEND_USER_POST = 15;
    private static final int VIEW_TYPE_TWO_WAY_FRIEND_USER_POST = 16;
    private static final int VIEW_TYPE_EVENT_USER_POST = 17;
    ...
    public FeedAdapter(Context context, List<Feed.FeedItem> feedItemsList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        } else if (viewType == VIEW_TYPE_NEWS_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_news_feed, parent, false);
            CellNewsViewHolder cellNewsViewHolder = new CellNewsViewHolder(view);
         //   this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellNewsViewHolder);
            return cellNewsViewHolder;
        } else if (viewType == VIEW_TYPE_EVENT_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_event_feed, parent, false);
            CellEventPostViewHolder cellEventPostViewHolder = new CellEventPostViewHolder(view);
        //    this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellEventPostViewHolder);
            return cellEventPostViewHolder;
        } else if (viewType == VIEW_TYPE_NEW_USER_JOINED) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_new_user_joined_feed, parent, false);
            CellNewUserJoinedViewHolder cellNewUserJoinedViewHolder = new CellNewUserJoinedViewHolder(view);
          //  this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellNewUserJoinedViewHolder);
            return cellNewUserJoinedViewHolder;
        } else if (viewType == VIEW_TYPE_USER_PROFILE_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_user_profile_feed, parent, false);
            CellUserProfilePostViewHolder cellUserProfilePostViewHolder = new CellUserProfilePostViewHolder(view);
            //this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellUserProfilePostViewHolder);
            return cellUserProfilePostViewHolder;
        } else if (viewType == VIEW_TYPE_FRIEND_PROFILE_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_friend_profile_feed, parent, false);
            CellFriendProfilePostViewHolder cellFriendProfilePostViewHolder = new CellFriendProfilePostViewHolder(view);
            //this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellFriendProfilePostViewHolder);
            return cellFriendProfilePostViewHolder;
        } else if (viewType == VIEW_TYPE_FRIEND_USER_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_friend_user_post_feed, parent, false);
            CellFriendUserPostViewHolder cellFriendUserPostViewHolder = new CellFriendUserPostViewHolder(view);
            //this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellFriendUserPostViewHolder);
            return cellFriendUserPostViewHolder;
        } else if (viewType == VIEW_TYPE_EVENT_USER_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_friend_user_post_feed, parent, false);
            CellEventUserPostViewHolder cellEventUserPostViewHolder = new CellEventUserPostViewHolder(view);
            //this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellEventUserPostViewHolder);
            return cellEventUserPostViewHolder;
        } else if (viewType == VIEW_TYPE_TWO_WAY_FRIEND_USER_POST) {
            View view = LayoutInflater.from(context).inflate(R.layout.item_two_way_friend_user_post_feed, parent, false);
            CellTwoWayFriendUserPostViewHolder cellTwoWayFriendUserPostViewHolder = new CellTwoWayFriendUserPostViewHolder(view);
            //this.recyclerView.setRecycledViewPool(mSharedPool);
            setupClickableViews(view, cellTwoWayFriendUserPostViewHolder);
            return cellTwoWayFriendUserPostViewHolder;
    ...
    private void setupClickableViews(View view, CellEventUserPostViewHolder cellFeedViewHolder) {
    ...
    private void setupClickableViews(View view, CellEventPostViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    private void setupClickableViews(View view, CellTwoWayFriendUserPostViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    private void setupClickableViews(View view, CellFriendProfilePostViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    private void setupClickableViews(View view, CellUserProfilePostViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    private void setupClickableViews(final View view, final CellFriendUserPostViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    private void setupClickableViews(final View view, final CellNewUserJoinedViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    private void setupClickableViews(final View view, final CellNewsViewHolder cellFeedViewHolder) {
        cellFeedViewHolder.btnComments.setOnClickListener(v -> {
            if(UserUtils.isGuestLoggedIn(view.getContext())){
                GuestLoginDialog.show(view.getContext());
                return;
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int position) {
        ...
        } else if (viewHolder instanceof  CellNewsViewHolder) {
            ((CellNewsViewHolder) viewHolder).bindView(feedItems.get(position));
        } else if (viewHolder instanceof  CellNewUserJoinedViewHolder) {
            ((CellNewUserJoinedViewHolder) viewHolder).bindView(feedItems.get(position));
        } else if (viewHolder instanceof  CellUserProfilePostViewHolder) {
            ((CellUserProfilePostViewHolder) viewHolder).bindView(feedItems.get(position));
        } else if (viewHolder instanceof  CellFriendProfilePostViewHolder) {
            ((CellFriendProfilePostViewHolder) viewHolder).bindView(feedItems.get(position));
        } else if (viewHolder instanceof  CellFriendUserPostViewHolder) {
            ((CellFriendUserPostViewHolder) viewHolder).bindView(feedItems.get(position));
        }  else if (viewHolder instanceof  CellTwoWayFriendUserPostViewHolder) {
            ((CellTwoWayFriendUserPostViewHolder) viewHolder).bindView(feedItems.get(position));
        } else if (viewHolder instanceof  CellEventPostViewHolder) {
            ((CellEventPostViewHolder) viewHolder).bindView(feedItems.get(position));
        } else if (viewHolder instanceof  CellEventUserPostViewHolder) {
            ((CellEventUserPostViewHolder) viewHolder).bindView(feedItems.get(position));
        }
    ...
    public int getItemViewType(int position) {
        if (feedItems != null && !feedItems.isEmpty() && feedItems.get(position).getPostType() != null){
            if (feedItems.get(position).getPostType().equalsIgnoreCase("newsPost")) {
                return VIEW_TYPE_NEWS_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("eventPost")) {
                return VIEW_TYPE_EVENT_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("newUserJoined")) {
                return VIEW_TYPE_NEW_USER_JOINED;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("userProfilePost")) {
                return VIEW_TYPE_USER_PROFILE_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("friendProfilePost")) {
                return VIEW_TYPE_FRIEND_PROFILE_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("eventUserPost")) {
                return VIEW_TYPE_EVENT_USER_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("userPost")) {
                return VIEW_TYPE_FRIEND_USER_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("friendPost")) {
                return VIEW_TYPE_FRIEND_USER_POST;
            } else if (feedItems.get(position).getPostType().equalsIgnoreCase("friendUserPost")) {
                return VIEW_TYPE_TWO_WAY_FRIEND_USER_POST;
            } else {
                return -1;
            }
        } else {
    ...
    public  class CellNewsViewHolder extends RecyclerView.ViewHolder {
        ...
        public CellNewsViewHolder(View itemView) {
            super(itemView);
        ...
        public void bindView(final Feed.FeedItem feedItem) {
            ...
            if(this.feedItem != null) {
                ...
                if (feedItem.getCompanyName() != null &&  !feedItem.getCompanyName().equalsIgnoreCase("") && feedItem.getCompanyId() != null &&  !feedItem.getCompanyId().equalsIgnoreCase("")){
    ...
    public  class CellNewUserJoinedViewHolder extends RecyclerView.ViewHolder {
        ...
        public CellNewUserJoinedViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
            ...
            if (this.feedItem != null) {
                ...
                if(tsCommentCounter != null){
                    if(feedItem.getCommentCount()==0) {
                        ...
                        tsCommentCounter.setCurrentText(tsCommentCounter.getResources().getQuantityString(
                                R.plurals.comments_count, feedItem.getCommentCount(), feedItem.getCommentCount()
                        ));
                    }
                }
                ...
                if(tsLikesCounter != null){
                    if(feedItem.getLikeCount()==0) {
                        ...
                        tsLikesCounter.setCurrentText(tsCommentCounter.getResources().getQuantityString(
                                R.plurals.likes_count, feedItem.getLikeCount(), feedItem.getLikeCount()
                        ));
                    }
                }
    ...
    public  class CellUserProfilePostViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.ic_report)
        ImageView btnReport;
        @BindView(R.id.btnComments)
        ImageButton btnComments;
        ...
        public CellUserProfilePostViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
        ...
        public void bindView(final Feed.FeedItem feedItem) {
            ...
            if(this.feedItem != null) {
                ...
                if (feedItem.getPostedUserName() != null) {
                    split = feedItem.getPostedUserName().split("\\s+");
                }
    ...
    public  class CellFriendProfilePostViewHolder extends RecyclerView.ViewHolder {
        ...
        public CellFriendProfilePostViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
    ...
    public  class CellEventPostViewHolder extends RecyclerView.ViewHolder {
        ...
        public CellEventPostViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
    ...
    public  class CellEventUserPostViewHolder extends RecyclerView.ViewHolder {
        ...
        public CellEventUserPostViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
    ...
    public  class CellFriendUserPostViewHolder extends RecyclerView.ViewHolder {
        @BindView(R.id.ic_report)
        ImageView btnReport;
        @BindView(R.id.btnComments)
        ImageButton btnComments;
        ...
        public CellFriendUserPostViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
        ...
        public void bindView(final Feed.FeedItem feedItem) {
            ...
            if(this.feedItem != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                    ...
                    int total = spanned.length();
                    spanned.setSpan(userNameClickableSpan, 0, s1, Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                    spanned.setSpan(new ForegroundColorSpan(Color.BLACK), 0, s1, 0);
                    spanned.setSpan(new StyleSpan(Typeface.BOLD), 0, s1, SPAN_INCLUSIVE_INCLUSIVE);
    ...
    public  class CellTwoWayFriendUserPostViewHolder extends RecyclerView.ViewHolder {
        ...
        public CellTwoWayFriendUserPostViewHolder(View itemView) {
            super(itemView);
            ButterKnife.bind(this, itemView);
        }
            ...
            if(this.feedItem != null) {
                ...
                if (feedItem.getStatus() != null && !feedItem.getStatus().equalsIgnoreCase("")){
                    if (feedItem.getStatus().length() > 350) {
                        ...
                        final String continueReading = "...Continue Reading";
                        String mergedString = splitString + continueReading;
                        ClickableSpan continueClickableSpan = new ClickableSpan() {
                        ...
                        sBuilder.setSpan(continueClickableSpan,
                                mergedString.indexOf(continueReading),
                                mergedString.indexOf(continueReading) + String.valueOf(continueReading).length(),
                                Spanned.SPAN_EXCLUSIVE_EXCLUSIVE);
                        sBuilder.setSpan(
