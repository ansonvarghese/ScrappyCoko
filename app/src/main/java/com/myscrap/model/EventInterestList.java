...
public class EventInterestList {
    ...
    private List<EventInterestListData> data = new ArrayList<>();
    ...
    public List<EventInterestListData> getData() {
        return data;
    }

    public void setData(List<EventInterestListData> data) {
        this.data = data;
    }

    public class EventInterestListData {
