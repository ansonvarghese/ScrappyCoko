...
public class ContactFavouritePosts extends Fragment implements  FeedsAdapter.OnFeedItemClickListener,
    ...
    public ContactFavouritePosts() {}


    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
                             Bundle savedInstanceState) {
        View postFragment = inflater.inflate(R.layout.fragment_contact_favourite_post, container, false);
        ...
        emptyView = postFragment.findViewById(R.id.empty);
        UserUtils.setEmptyView(emptyView, R.drawable.ic_favorites_empty, "No Favourite Posts", false);
    ...
    public void onResume() {
        ...
        loadFeed();
        if(mTracker != null){
            mTracker.setScreenName("Favourite Post Screen");
    ...
    public void getFeeds(String pageLoad, String userId, String friendId, String apiKey){
        ...
        String companyId = "0";
                apiService.getUserFavouritedPosts(pageLoad, userId, friendId, companyId,apiKey)
    ...
    private void parseFeeds(Feed mFeed) {
