...
public class ContactModerators extends Fragment implements FavouriteFragmentAdapter.FavouriteFragmentAdapterListener, SearchView.OnQueryTextListener{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        View mFavouritesFragment = inflater.inflate(R.layout.fragment_contact_moderators, container, false);
        ...
        UserUtils.setEmptyView(emptyView, R.drawable.ic_favorites_empty, "No Moderators", false);
        listener = this;
    ...
    private void loadContactModerators() {
        ...
        if (CheckNetworkConnection.isConnectionAvailable(AppController.getInstance())){
            ...
            //Call<Favourite> call =
                    apiService.moderators(userId, apiKey)
                    ...
                    .subscribe(new Subscriber<Favourite>() {
                        ...
                        public void onNext(Favourite mFavourite) {
                            ...
                            if (mFavourite != null) {
                                ...
                                if(swipe != null)
                                    SnackBarDialog.show(swipe, "Try again later!");
                            }
                            Log.d("moderators", "onSuccess");
                        }
                    });
        } else {
            if(swipe != null)
