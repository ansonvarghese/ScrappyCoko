...
public class ChatMessagesTable extends SQLiteOpenHelper
{
    private static final String DATABASE_NAME="MYSCRAP_XMPP_STORAGE";
    private static final int DATABASE_VERSION=1;

    private static final String TABLE_NAME="chatMessagesTable2";
    ...
    public ChatMessagesTable(Context context)
    {
