...
public class FeedAdapter$CellFriendUserPostViewHolder_ViewBinding implements Unbinder {
  private FeedAdapter.CellFriendUserPostViewHolder target;

  @UiThread
  public FeedAdapter$CellFriendUserPostViewHolder_ViewBinding(FeedAdapter.CellFriendUserPostViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedAdapter.CellFriendUserPostViewHolder target = this.target;
