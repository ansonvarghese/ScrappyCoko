...
public class FeedsAdapter$CellFeedViewHolder_ViewBinding implements Unbinder {
  private FeedsAdapter.CellFeedViewHolder target;

  @UiThread
  public FeedsAdapter$CellFeedViewHolder_ViewBinding(FeedsAdapter.CellFeedViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedsAdapter.CellFeedViewHolder target = this.target;
