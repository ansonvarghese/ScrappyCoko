...
public class FeedAdapter$CellNewsViewHolder_ViewBinding implements Unbinder {
  private FeedAdapter.CellNewsViewHolder target;

  @UiThread
  public FeedAdapter$CellNewsViewHolder_ViewBinding(FeedAdapter.CellNewsViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedAdapter.CellNewsViewHolder target = this.target;
