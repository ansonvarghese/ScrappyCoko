...
public class FeedAdapter$CellUserProfilePostViewHolder_ViewBinding implements Unbinder {
  private FeedAdapter.CellUserProfilePostViewHolder target;

  @UiThread
  public FeedAdapter$CellUserProfilePostViewHolder_ViewBinding(FeedAdapter.CellUserProfilePostViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedAdapter.CellUserProfilePostViewHolder target = this.target;
