...
public class FeedAdapter$CellTwoWayFriendUserPostViewHolder_ViewBinding implements Unbinder {
  private FeedAdapter.CellTwoWayFriendUserPostViewHolder target;

  @UiThread
  public FeedAdapter$CellTwoWayFriendUserPostViewHolder_ViewBinding(FeedAdapter.CellTwoWayFriendUserPostViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedAdapter.CellTwoWayFriendUserPostViewHolder target = this.target;
