...
public class FeedAdapter$CellEventUserPostViewHolder_ViewBinding implements Unbinder {
  private FeedAdapter.CellEventUserPostViewHolder target;

  @UiThread
  public FeedAdapter$CellEventUserPostViewHolder_ViewBinding(FeedAdapter.CellEventUserPostViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    FeedAdapter.CellEventUserPostViewHolder target = this.target;
